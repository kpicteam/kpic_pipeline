...
if __name__ == "__main__":
    ...
    # background
    if mode == "science":
        background_med_filename = os.path.join(kap_And_dir,"calib","background600_med.fits")
    elif mode == "star":
        background_med_filename = os.path.join(kap_And_dir,"calib","background60_med.fits")
    hdulist = pyfits.open(background_med_filename)
    background_med = hdulist[0].data
    if mode == "science":
        background_badpixmap_filename = os.path.join(kap_And_dir,"calib","background600_badpixmap.fits")
    elif mode == "star":
        background_badpixmap_filename = os.path.join(kap_And_dir,"calib","background60_badpixmap.fits")
