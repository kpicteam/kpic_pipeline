...
if __name__ == "__main__":
    ...
    #background
    background60_med_filename = os.path.join(kap_And_dir,"calib","background_star_med.fits")
    hdulist = pyfits.open(background60_med_filename)
    background60_med = hdulist[0].data
    background60_badpixmap_filename = os.path.join(kap_And_dir,"calib","background_star_badpixmap.fits")
